...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/leonardo-fragoso-921b166a/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/LeonardoRFragoso',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/pyscript.tech/',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Email',
      url: 'mailto:contato@pyscript.tech',
      icon: (
      ...
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerColumn}>
            ...
            <div className={styles.footerContact}>
              <a href="mailto:contato@pyscript.tech" className={styles.contactItem}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                  <polyline points="22,6 12,13 2,6"/>
                </svg>
                contato@pyscript.tech
              </a>
              <a href="https://wa.me/+5521980292791" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>
            © {currentYear} <Link to="/">PyScript.tech</Link>. Todos os direitos reservados.
          </p>
